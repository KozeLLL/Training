// Теоретичні питання
//
// Опишіть своїми словами що таке Document Object Model (DOM) - це список тегів (структура) з яких складається сторінка в браузері (сайт)
// Яка різниця між властивостями HTML-елементів innerHTML та innerText? innerText додасть наповнення як текст, а innerHTML може додати структуру в середину тега, який ми виберемо
